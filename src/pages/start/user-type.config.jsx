// JSON array of button data with title and SVG icon
export const userTypeItems = [
  {
    title: "Individual Account",
    id: "chatgpt",
    description:"Create a new User to join a given Organization / Group Id",
    ...
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-newspaper">
        ...
        <path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16"></path>
  ...
  },
  {
    ...
    id:"orgnization",
    description:"Create a new Organization / Group and Admin User for it.",
    svg: (
